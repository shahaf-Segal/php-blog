...
$salts = array_map(function () {
    return bin2hex(random_bytes(16));
}, range(1, 3));

$users = [
    ['name' => 'Admin User', 'email' => 'admin@example.com', 'password' => password_hash('admin123' . $salts[0], PASSWORD_DEFAULT), 'salt' => $salts[0], 'role' => 'admin'],
    ['name' => 'John Doe', 'email' => 'john@example.com', 'password' => password_hash('password123' . $salts[1], PASSWORD_DEFAULT), 'salt' => $salts[1], 'role' => 'user'],
    ['name' => 'Jane Smith', 'email' => 'jane@example.com', 'password' => password_hash('password123' . $salts[2], PASSWORD_DEFAULT), 'salt' => $salts[2], 'role' => 'user'],
];
$posts = [
